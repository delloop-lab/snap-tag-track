        ...
        <div className="flex h-16 justify-between">
          <div className="flex items-center">
            <Link to="/landing2" className="flex shrink-0 items-center">
              <img
                className={cn("h-8 w-auto", user && "brightness-110")}
              ...
              <>
                ...
                <div className="md:hidden">
                  ...
                  >
                    ...
                    {isMenuOpen ? (
                      <X className="block h-6 w-6" aria-hidden />
                    ) : (
                      <Menu className="block h-6 w-6" aria-hidden />
                    )}
                  </button>
                </div>

                {isMenuOpen && (
                  <div className="absolute left-0 right-0 top-16 z-50 border-b border-slate-600 bg-slate-900 shadow-xl md:hidden">
