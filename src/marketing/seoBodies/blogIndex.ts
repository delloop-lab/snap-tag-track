...
export const blogIndexBody: SeoPageBody = {
  ...
  intro: [
    ...
    "If you want a specific topic covered—contractor taxes, household fuel trends, or warranty claim checklists—contact us through the contact page.",
  ...
  sections: [
    ...
    {
      h2: "Why a blog matters for honest SEO",
      paragraphs: [
        "Search engines reward useful answers. Short keyword pages help intent; deeper posts help nuance. Snap Tag Track will publish here when there is something genuinely useful to say—no filler schedules.",
        "We prefer practical examples, failure cases, and repeatable checklists over abstract advice. Each article should help you take one concrete action in your own receipt workflow.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "Send topic requests via the contact page if a gap matters to your business. Prioritised writing follows real reader questions—not keyword spreadsheets alone.",
    ...
    {
      h2: "Upcoming article themes",
      paragraphs: [
        "Planned themes include returns and chargeback readiness, seasonal household spend patterns, contractor reimbursement workflows, and practical warranty claim preparation.",
        "We also plan side-by-side comparisons of receipt-first tracking versus bank-feed-first tracking so readers can choose based on context, not marketing promises.",
        "If a topic is urgent for your team, contact us with your scenario and constraints. Real-world prompts directly influence publishing priority.",
      ],
    },
    {
  ...
  faq: [
    {
      ...
      answer:
        "Not yet. Bookmark this page or subscribe to product updates through contact if you need notifications.",
    },
    {
      question: "Where should I go for FAQs?",
      answer:
        "Use the Help page for product questions and troubleshooting.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. Use the contact page with your scenario, current workflow, and biggest blocker. We prioritise topics that solve repeated real-world problems.",
    },
  ],
};
