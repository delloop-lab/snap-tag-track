...
type HelpFaqSection = {
  id: string;
  question: string;
  /** Plain text for FAQPage JSON-LD (must align with visible answer). */
  answerPlain: string;
  content: ReactNode;
};

/** Rich FAQ entries (accordion). Order is fixed; pricing last. */
const HELP_FAQ_SECTIONS: HelpFaqSection[] = [
  {
    id: "what-is-snaptagtrack",
    question: "What is SnapTagTrack?",
    answerPlain:
      "SnapTagTrack turns messy purchases into organised records: snap a receipt for receipt tracking, tag it for expense tracking, and keep warranty reminder context so nothing gets lost.",
    content: (
      <div className="space-y-3">
        <p>
          SnapTagTrack is a simple way to turn messy, real-world purchases into clean, organised records—built
          for <strong className="font-semibold text-slate-100">receipt tracking</strong>,{" "}
          <strong className="font-semibold text-slate-100">expense tracking</strong>, and{" "}
          <strong className="font-semibold text-slate-100">warranty reminder</strong> workflows without linking
          your bank.
        </p>
        <p>
          Instead of typing everything manually, you just snap a receipt, tag it, and it becomes searchable,
          trackable, and useful later.
        </p>
        <p className="font-medium text-slate-100">It&apos;s built for one job:</p>
        <p>
          Make sure you never lose track of what you&apos;ve spent, what you&apos;ve bought, or what you might
          need again.
        </p>
      </div>
    ),
  },
  {
    ...
    answerPlain:
      "SnapTagTrack captures receipts and invoices, lets you tag and organise them for expense tracking, and keeps everything searchable. Warranty reminder and proof-of-purchase context stay with each item.",
    content: (
      <div className="space-y-3">
        <p>At its core, SnapTagTrack does three things really well for receipt tracking and expense tracking:</p>
        <div className="space-y-3 pl-0 sm:pl-1">
          ...
          <div>
            ...
            <p className="mt-1">
              You tag it your way. Categories, notes, context, whatever matters to you—including warranty
              reminder dates when you have them.
            </p>
          </div>
          <div>
            <p className="font-semibold text-slate-100">Track</p>
            <p className="mt-1">
              Everything becomes searchable and structured, so you can find it later without digging through
              emails, drawers, or WhatsApp threads.
            </p>
          </div>
        </div>
        <p>
          Over time, it builds a complete picture of your spending and purchases without you having to think
          about it.
        </p>
      </div>
    ),
  },
  {
    ...
    answerPlain:
      "You snap a receipt, the system reads key fields, you tag for expense tracking, and records sync for later search. Receipt tracking stays fast with no spreadsheet setup.",
    content: (
      <div className="space-y-3">
  ...
  },
  {
    ...
    answerPlain:
      "Receipt tracking improves as you add more tagged receipts. You stay in control of categories, and messy real-world scans are normal—clear photos still help warranty reminder accuracy.",
    content: (
      <div className="space-y-3">
        <p>This is where most people get it wrong, so let&apos;s be clear.</p>
        <div className="space-y-3">
          <p>
            <span className="font-semibold text-slate-100">It&apos;s not magic.</span> It gets better with use.
            The more receipts you add and tag, the smarter and more useful it becomes for expense tracking.
          </p>
          <p>
            <span className="font-semibold text-slate-100">You&apos;re still in control.</span> You can edit,
            adjust, and categorise things however you want. It&apos;s not forcing rigid accounting rules on you.
          </p>
          <p>
          ...
          <p>
            <span className="font-semibold text-slate-100">It replaces effort, not thinking.</span> You&apos;ll
            spend seconds capturing something instead of minutes trying to reconstruct it later.
          </p>
        </div>
      </div>
    ),
  },
  {
    ...
    answerPlain:
      "People use SnapTagTrack for day-to-day expense tracking, tax and business receipts, warranty reminder storage, remembering purchase details, and controlling fragmented spending.",
    content: (
      <div className="space-y-2">
        <ul className="list-disc space-y-2 pl-5">
          <li>Tracking day-to-day spending without spreadsheets</li>
          <li>Keeping receipts for tax or business expenses</li>
          <li>Storing warranties and proof for warranty reminder follow-ups</li>
  ...
  },
  {
    ...
    answerPlain:
      "SnapTagTrack is not full accounting software, not a replacement for your accountant, and not perfect on unreadable receipts. It is a practical receipt tracking and expense tracking tool with less friction.",
    content: (
      <div className="space-y-3">
  ...
  },
  {
    ...
    answerPlain:
      "Until further notice SnapTagTrack is free to use with a limit of 35 receipt scans per year.",
    content: (
      <p>
...
export default function Help() {
  ...
  const helpFaqJsonLd = useMemo(
    () =>
      JSON.stringify({
        "@context": "https://schema.org",
        "@type": "FAQPage",
        mainEntity: HELP_FAQ_SECTIONS.map(({ question, answerPlain }) => ({
          "@type": "Question",
          name: question,
          acceptedAnswer: {
            "@type": "Answer",
  ...
  return (
    <div className="min-h-screen w-full bg-slate-800 text-slate-100">
      <Helmet>
        <script type="application/ld+json">{helpFaqJsonLd}</script>
      </Helmet>
            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-12">
              <div className="text-center lg:text-left lg:justify-self-start">
                ...
                <h1 className="text-balance text-3xl font-extrabold tracking-tight text-white sm:text-4xl md:text-5xl">
                  Help: receipt tracking, warranty reminders &amp; expense tracking
                </h1>
                <p className="mx-auto mt-4 max-w-xl text-pretty text-base leading-relaxed text-slate-300 sm:text-lg lg:mx-0 lg:max-w-lg">
                  Learn how <strong className="font-semibold text-slate-100">receipt tracking</strong>,{" "}
                  <strong className="font-semibold text-slate-100">warranty reminder</strong> setup, and{" "}
                  <strong className="font-semibold text-slate-100">expense tracking</strong> fit together in
                  SnapTagTrack—FAQs, scan quality tips, and photo examples below.
                </p>
              </div>
      ...
      <main className="mx-auto max-w-6xl px-4 pb-28 sm:px-6 lg:px-10">
        ...
        >
          ...
          <h3 className="mb-2 text-sm font-semibold tracking-tight text-slate-200 sm:text-base">
            Receipt tracking, warranty reminders &amp; expense tracking
          </h3>
          <p className="mb-5 max-w-3xl text-sm leading-relaxed text-slate-400 sm:text-[15px]">
            These answers mirror what you&apos;ll do in the product: capture proof for returns, organise tags
            for spending, and keep warranty reminder context next to the receipt image.
          </p>
